...
public class ThreadCenter {
     ...
     * 公共业务线程池
     */
    private static CommonBusinessExecutor COMMON_BUSINESS_CONTAINER = new CommonBusinessExecutor("common business", CORE_SIZE * 2);

    /**
     * 登录登出匿名任务队列
     */
    private static CommonMailGroup LOGIN_QUEUE = COMMON_BUSINESS_CONTAINER.commonMailGroup("login-io", 4);
